...
scenario_sim2 <- purrr::partial(scenario_sim,
                                ...
                                cap_max_days = 30, R = 1, presymrate = 0.4,
...
saveRDS(out, file = "data-raw/infection_rates_asym90.rds")
saveRDS(out2, file = "data-raw/infection_rates_asym40.rds")
